...
st.set_page_config(page_title="Secured Inspection Audit", page_icon="🛡️", layout="centered")

# تصميم مخصص لجعل التطبيق يشبه تطبيقات الموبايل (مناسب لجهاز iPhone 16 Pro Max)
st.markdown("""
    <style>
...
# الهيدر والعنوان
st.title("🛡️ Secured Logistics Audit")
st.write("Dubai Airport Free Zone | UAE")

# --- [1. بيانات العميل] ---
st.info("📋 Report Header Information")
    ...
    if st.button("🚀 SAVE TO GOOGLE DRIVE", type="primary"):
        with st.spinner("Uploading to Secured Cloud..."):
            ...
            try:
                ...
                st.success("✅ Successfully Synchronized with Google Drive!")
                st.balloons()
            except:
                st.warning("⚠️ Data sent! Check your Drive folder.")
